...
export const tabs = [
  ...
  },
  {
    id: 'planeacion',
    label: 'Planeación',
    tooltip: 'Agenda y disponibilidad del equipo',
    path: '/dashboard/planeacion',
    icon: <CalendarClock className='icon-size' />,
  },
  {
    id: 'mis-tareas',
    label: 'Mis tareas',
    tooltip: 'Pendientes y calendario del técnico',
    path: '/dashboard/mis-tareas',
    icon: <ClipboardCheck className='icon-size' />,
  },
  {
    id: 'inspecciones',
    label: 'Inspecciones',
